    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%', position: 'relative', overflow: 'hidden', background: '#050308', fontFamily: "ui-monospace, 'SF Mono', Menlo, Consolas, monospace" }}>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '16px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                {/* ==========================================================
                   VIEW 3: THE BUILT-OUT API PANEL (Live NanoGPT Model Registry)
                   ========================================================== */}
                {activeView === 'api' && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>

                        <div style={{ borderBottom: '1px solid rgba(0, 255, 157, 0.2)', paddingBottom: '8px' }}>
                            <h3 style={{ margin: '0 0 4px 0', color: '#00ff9d', fontSize: '15px', fontWeight: 900 }}>
                                &gt; NEURAL_API_MATRIX
                            </h3>
                            <p style={{ margin: 0, fontSize: '10px', color: 'rgba(0, 255, 157, 0.6)' }}>
                                // NanoGPT BYOK Gateway & Live Cloud Model Population
                            </p>
                        </div>

                        {/* BYOK NanoGPT Key Input Box */}
                        <div style={{ background: '#0B0914', border: '1px solid rgba(0, 229, 255, 0.3)', borderRadius: '6px', padding: '14px' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                                <label style={{ color: '#00e5ff', fontSize: '11px', fontWeight: 'bold' }}>
                                    &gt; NANOGPT_API_KEY:
                                </label>
                                <span style={{ fontSize: '9px', color: apiKey ? '#00ff9d' : '#ff9900' }}>
                                    {apiKey ? '● KEY CONFIGURED' : '○ NO KEY SET'}
                                </span>
                            </div>
                            ...
                            <div style={{ display: 'flex', gap: '8px', marginBottom: '6px' }}>
                                <div style={{ position: 'relative', flex: 1 }}>
                                    <input
                                        ...
                                        placeholder="Paste NanoGPT API Key (UUID v4 e.g. c7b39a36-...)"
                                        style={{
                                            width: '100%',
                            ...
                            <div style={{ fontSize: '9px', color: 'rgba(255, 255, 255, 0.4)', marginBottom: '10px' }}>
                                💡 NanoGPT keys are standard UUID v4 strings (e.g. <code>c7b39a36-6e97-48c5-9276-8086ef65e495</code>). Quotes &amp; "Bearer" are auto-stripped!
                            </div>

                            {/* Ping & Telemetry Tester */}
                            <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                                <button
                                    ...
                                    style={{
                                        padding: '7px 12px',
                                        background: isPinging ? 'rgba(255,255,255,0.05)' : 'rgba(0, 255, 157, 0.15)',
                                        border: '1px solid #00ff9d',
                                        color: '#00ff9d',
                                        fontSize: '10px',
                                        fontWeight: 'bold',
                                ...
                                >
                                    {isPinging ? 'Checking Balance & Ping...' : '⚡ Test Connection Ping'}
                                </button>
                                ...
                                <button
                                    ...
                                    disabled={isLoadingModels || isLoadingImageModels}
                                    style={{
                                        padding: '7px 12px',
                                        background: 'transparent',
                                        border: '1px solid rgba(0, 229, 255, 0.4)',
                                ...
                                >
                                    {isLoadingModels || isLoadingImageModels ? 'Fetching...' : '🔄 Refresh All Models'}
                                </button>
                            </div>
                        ...
                        {/* MATRIX SUB-TABS: CHAT vs IMAGE GEN */}
                        <div style={{ display: 'flex', gap: '8px' }}>
                            <button
                                onClick={() => setApiMatrixSubTab('chat')}
                                style={{
                                    flex: 1,
                                    padding: '9px 12px',
                                    fontSize: '11px',
                                    ...
                                    borderRadius: '4px',
                                    cursor: 'pointer',
                                    background: apiMatrixSubTab === 'chat' ? 'rgba(0, 255, 157, 0.18)' : 'rgba(255, 255, 255, 0.04)',
                                    border: apiMatrixSubTab === 'chat' ? '1px solid #00ff9d' : '1px solid rgba(255, 255, 255, 0.1)',
                                    color: apiMatrixSubTab === 'chat' ? '#00ff9d' : 'rgba(255, 255, 255, 0.5)',
                                    boxShadow: apiMatrixSubTab === 'chat' ? '0 0 10px rgba(0, 255, 157, 0.2)' : 'none',
                                    display: 'flex',
                                    alignItems: 'center',
                                    justifyContent: 'center',
                                    gap: '6px'
                            ...
                            >
                                ...
                                <span style={{ fontSize: '9px', background: apiMatrixSubTab === 'chat' ? '#00ff9d' : 'rgba(255,255,255,0.1)', color: apiMatrixSubTab === 'chat' ? '#000' : '#888', padding: '1px 5px', borderRadius: '10px' }}>
                                    {models.length}
                                </span>
                            </button>
                            <button
                                onClick={() => setApiMatrixSubTab('image')}
                                style={{
                                    flex: 1,
                                    padding: '9px 12px',
                                    fontSize: '11px',
                                    ...
                                    borderRadius: '4px',
                                    cursor: 'pointer',
                                    background: apiMatrixSubTab === 'image' ? 'rgba(255, 16, 122, 0.18)' : 'rgba(255, 255, 255, 0.04)',
                                    border: apiMatrixSubTab === 'image' ? '1px solid #ff107a' : '1px solid rgba(255, 255, 255, 0.1)',
                                    color: apiMatrixSubTab === 'image' ? '#ff107a' : 'rgba(255, 255, 255, 0.5)',
                                    boxShadow: apiMatrixSubTab === 'image' ? '0 0 10px rgba(255, 16, 122, 0.2)' : 'none',
                                    display: 'flex',
                                    alignItems: 'center',
                                    justifyContent: 'center',
                                    gap: '6px'
                            ...
                            >
                                ...
                                <span style={{ fontSize: '9px', background: apiMatrixSubTab === 'image' ? '#ff107a' : 'rgba(255,255,255,0.1)', color: apiMatrixSubTab === 'image' ? '#fff' : '#888', padding: '1px 5px', borderRadius: '10px' }}>
                                    {imageModels.length}
                                </span>
                            </button>
                        </div>
                            ...
                            <div style={{ background: '#0B0914', border: '1px solid rgba(0, 255, 157, 0.3)', borderRadius: '6px', padding: '14px' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '12px' }}>
                                    <input
                                        ...
                                        placeholder="Filter models by name (e.g. gpt-4o, claude, gemma, deepseek)..."
                                        style={{
                                            width: '100%',
                                            padding: '7px 10px',
                                            background: '#050308',
                                    ...
                                    <div style={{ display: 'flex', gap: '4px', overflowX: 'auto', paddingBottom: '4px' }}>
                                        {['ALL', 'OPENAI', 'ANTHROPIC', 'DEEPSEEK', 'GOOGLE', 'MISTRAL', 'UNCENSORED'].map(p => (
                                            <button
                                                key={p}
                                                ...
                                                style={{
                                                    ...
                                                    cursor: 'pointer',
                                                    whiteSpace: 'nowrap',
                                                    background: selectedProvider === p ? 'rgba(0, 255, 157, 0.2)' : 'rgba(255,255,255,0.03)',
                                                    border: selectedProvider === p ? '1px solid #00ff9d' : '1px solid rgba(255,255,255,0.1)',
                                                    color: selectedProvider === p ? '#00ff9d' : 'rgba(255,255,255,0.5)'
                                                }}
                                            >
                                                {p}
                                            </button>
                                ...
                                {/* Model List Cards */}
                                {isLoadingModels ? (
                                    <div style={{ padding: '20px', textAlign: 'center', color: '#00ff9d', fontSize: '11px' }}>
                                        <div style={{ display: 'inline-block', width: '16px', height: '16px', border: '2px solid rgba(0,255,157,0.3)', borderTopColor: '#00ff9d', borderRadius: '50%', animation: 'spin 0.8s linear infinite', marginBottom: '8px' }}></div>
                                        <div>[QUERYING NANOGPT MODEL REGISTRY...]</div>
                                    </div>
                                ) : filteredModels.length === 0 ? (
                                    <div style={{ padding: '16px', textAlign: 'center', color: 'rgba(255,255,255,0.4)', fontSize: '10px' }}>
                                        No models matching "{modelSearch}". Try another search term!
                                    </div>
                                ) : (
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    style={{
                                                        ...
                                                        boxShadow: isSelected ? '0 0 10px rgba(0, 229, 255, 0.2)' : 'none',
                                                        transition: 'all 0.15s ease'
                                                    }}
                                                >
                                                    <div style={{ overflow: 'hidden', marginRight: '8px' }}>
                                                        <div style={{ color: isSelected ? '#00e5ff' : '#fff', fontSize: '11px', fontWeight: 'bold', whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>
                                                            {m.id}
                                                        </div>
                                                        <div style={{ display: 'flex', gap: '6px', marginTop: '2px' }}>
                                                            <span style={{ fontSize: '8.5px', color: '#00ff9d', background: 'rgba(0,255,157,0.1)', padding: '1px 5px', borderRadius: '2px' }}>
                                                                {m.owned_by || 'ai'}
                                                            </span>
                                                            {m.id.includes('thinking') && (
                                                                <span style={{ fontSize: '8.5px', color: '#ffd700', background: 'rgba(255,215,0,0.1)', padding: '1px 5px', borderRadius: '2px' }}>
                                                                    reasoning
                                                                </span>
                                                            )}
                                                        </div>
                                                    ...
                                                    <button
                                                        ...
                                                        style={{
                                                            ...
                                                            color: isSelected ? '#000' : 'rgba(0, 229, 255, 0.8)',
                                                            border: '1px solid #00e5ff',
                                                            whiteSpace: 'nowrap'
                                                        }}
                                                    >
                        ...
                        {/* SUB-VIEW 2: IMAGE GENERATION MODELS MATRIX */}
                        {apiMatrixSubTab === 'image' && (
                            <div style={{ background: '#0B0914', border: '1px solid rgba(255, 16, 122, 0.3)', borderRadius: '6px', padding: '14px' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                                    <div style={{ color: '#ff107a', fontSize: '11px', fontWeight: 'bold' }}>
                                        &gt; LIVE_IMAGE_GEN_MATRIX ({filteredImageModels.length} of {imageModels.length})
                                    </div>
                                    <div style={{ fontSize: '9px', color: 'rgba(255,255,255,0.5)' }}>
                                        Active: <strong style={{ color: '#ff77aa' }}>{activeImageModel}</strong>
                                    </div>
                                </div>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '12px' }}>
                                    <input
                                        ...
                                        placeholder="Filter image models (e.g. flux, anime, zuki, dall-e, real, sdxl, doubao)..."
                                        style={{
                                            width: '100%',
                                            padding: '7px 10px',
                                            background: '#050308',
                                    ...
                                    <div style={{ display: 'flex', gap: '4px', overflowX: 'auto', paddingBottom: '4px' }}>
                                        {['ALL', 'FLUX', 'ANIME', 'CIVITAI', 'OPENAI', 'REALISTIC', 'IDEOGRAM', 'KREA', 'DOUBAO'].map(cat => (
                                            <button
                                                key={cat}
                                                ...
                                                style={{
                                                    ...
                                                    cursor: 'pointer',
                                                    whiteSpace: 'nowrap',
                                                    background: selectedImageCategory === cat ? 'rgba(255, 16, 122, 0.2)' : 'rgba(255,255,255,0.03)',
                                                    border: selectedImageCategory === cat ? '1px solid #ff107a' : '1px solid rgba(255,255,255,0.1)',
                                ...
                                {isLoadingImageModels ? (
                                    <div style={{ padding: '20px', textAlign: 'center', color: '#ff107a', fontSize: '11px' }}>
                                        <div style={{ display: 'inline-block', width: '16px', height: '16px', border: '2px solid rgba(255,16,122,0.3)', borderTopColor: '#ff107a', borderRadius: '50%', animation: 'spin 0.8s linear infinite', marginBottom: '8px' }}></div>
                                        <div>[QUERYING NANOGPT IMAGE MODEL MATRIX...]</div>
                                    </div>
                                ) : filteredImageModels.length === 0 ? (
                                    <div style={{ padding: '16px', textAlign: 'center', color: 'rgba(255,255,255,0.4)', fontSize: '10px' }}>
                                        No image models matching "{imageModelSearch}". Try another search term!
                                    </div>
                                ) : (
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', maxHeight: '320px', overflowY: 'auto' }}>
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    style={{
                                                        ...
                                                        boxShadow: isSelected ? '0 0 10px rgba(255, 16, 122, 0.2)' : 'none',
                                                        transition: 'all 0.15s ease'
                                                    }}
                                                >
                                                    <div style={{ overflow: 'hidden', marginRight: '8px' }}>
                                                        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                                                            <span style={{ color: isSelected ? '#ff107a' : '#fff', fontSize: '11px', fontWeight: 'bold', whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>
                                                                {m.name || m.id}
                                                            </span>
                                                            {m.pricing && (
                        ...
                        {/* Endpoints Telemetry Information */}
                        <div style={{ background: '#0B0914', border: '1px solid rgba(255, 255, 255, 0.1)', borderRadius: '6px', padding: '12px' }}>
                            <div style={{ color: 'rgba(255, 255, 255, 0.6)', fontSize: '10px', fontWeight: 'bold', marginBottom: '6px' }}>
                                &gt; TELEMETRY_NETWORK_ENDPOINTS
                            </div>
                            <div style={{ fontSize: '9px', color: 'rgba(255, 255, 255, 0.4)', lineHeight: 1.6 }}>
                                <div>• Chat: <span style={{ color: '#00e5ff' }}>https://nano-gpt.com/api/v1/chat/completions</span></div>
                                <div>• Image: <span style={{ color: '#ff107a' }}>https://nano-gpt.com/api/v1/images/generations</span></div>
                                <div>• Balance/Auth: <span style={{ color: '#ffd700' }}>https://nano-gpt.com/api/check-balance</span></div>
                                <div>• Chat Models: <span style={{ color: '#00ff9d' }}>https://nano-gpt.com/api/v1/models</span></div>
                                <div>• Image Models: <span style={{ color: '#ff77aa' }}>https://nano-gpt.com/api/v1/images/models</span></div>
                            </div>
                        </div>
